...
# get a session!
session = InstaPy(username='shre_ya3401', password='animal44')
...
with smart_run(session):
    ...
    session.like_by_tags(['masti', 'indianfood', 'indianhandsome','reelitfeelit','desi','desicouple','lovecouples','handsome','indianmen','indianboy','desiboy'
                'indianreels','indian','feelitreelit','reelsindia'], amount=8000)
