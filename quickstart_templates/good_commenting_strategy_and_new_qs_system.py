...
# get a session!
session = InstaPy(username='shre_ya3401', password='animal44', headless_browser=True)

# let's go! :>
with smart_run(session):
    hashtags = ['indianhandsome', 'masti', 'indianfood','reelitfeelit','desi','desicouple','lovecouples','handsome','indianmen','indianboy','desiboy'
                'travelingcouple','indian','feelitreelit','reelsindia']
    ...
    session.set_comments([
                             ...
                             u'Nice shot! :fire::fire::fire:@{}',
                              u'I love your profile! :heart::heart: @{}',
