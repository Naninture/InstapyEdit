...
# login credentials
insta_username = 'shre_ya3401'
insta_password = 'animal44'
...
like_tag_list = ['masti', 'indianfood', 'indianhandsome','reelitfeelit','desi','desicouple','lovecouples','handsome','indianmen','indianboy','desiboy'
                'indianreels','indian','feelitreelit','reelsindia']
...
with smart_run(session):
    ...
    """
    photo_comments = ['Nice shot! :fire::fire::fire:@{}',
        'I love your profile! :heart::heart:@{}',
        'Wonderful :thumbsup:',
        'Just incredible :open_mouth:',
        'What camera did you use @{}?',
        'Love your posts:heart::heart: @{}',
        'Looks awesome:fire::fire::fire: @{}',
